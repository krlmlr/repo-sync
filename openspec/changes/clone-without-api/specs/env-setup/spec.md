...
- **THEN** the connection is refused rather than trusted silently;
  adding the host key is a documented one-time setup step, not something the tooling bypasses

## REMOVED Requirements

### Requirement: gh authentication documented as prerequisite

**Reason**: No script in the project calls `gh` any more.
Cloning and updating mirrors is `git` over SSH throughout,
